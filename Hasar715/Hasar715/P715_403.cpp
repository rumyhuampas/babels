...
//
void
ImpresorFiscalP715_403::AbrirDNFH (DocumentosNoFiscalesHomologados Tipo, const std::string &Nro) throw (Excepcion)
{
	// printf ("Comando AbrirDNFH ejecutado en P715_403\n");
	...
	// Ejecutamos el método de la SuperClase 'ImpresorFiscalP715'
	ImpresorFiscalP715::AbrirDNFH (Tipo, Nro);
}
