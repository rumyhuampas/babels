...
//
std::string
ImpresorFiscalP272_100::ObtenerVersionDelControlador () throw (Excepcion)
{
    // printf ("Comando ObtenerVersionDelControlador ejecutado en P272_100\n");
...
//
void
ImpresorFiscalP272_100::BajaFiscal (const std::string &NumeroDeSerie) throw(Excepcion)
{
    // printf ("Comando BajaFiscal ejecutado en P272_100\n");
...
//
void
ImpresorFiscalP272_100::CambiarCodigoIngresosBrutos (const std::string &CodigoIngBr) throw(Excepcion)
{
    // printf ("Comando CambiarCodigoIngresosBrutos ejecutado en P272_100\n");
...
//
void
ImpresorFiscalP272_100::CambiarFechaInicioActividades (const FECHA &Fecha) throw(Excepcion)
{
    // printf ("Comando CambiarFechaInicioActividades ejecutado en P272_100\n");
...
ImpresorFiscalP272_100::DocumentoEnCurso () throw(Excepcion)
{
    // printf ("Comando DocumentoEnCurso ejecutado en P272_100\n");
...
//
std::string 
ImpresorFiscalP272_100::DescripcionDocumentoEnCurso () throw(Excepcion)
{
    // printf ("Comando DescripcionDocumentoEnCurso ejecutado en P272_100\n");
...
//
bool
ImpresorFiscalP272_100::UltimoDocumentoFueCancelado () throw(Excepcion)
{
    // printf ("Comando UltimoDocumentoCancelado ejecutado en P272_100\n");
...
//
unsigned
ImpresorFiscalP272_100::PrimerNumeroDeDocumentoActual () throw(Excepcion)
{
    // printf ("Comando PrimerNumeroDeDocumentoActual ejecutado en P272_100\n");
...
//
void
ImpresorFiscalP272_100::CancelarComprobanteFiscal () throw(Excepcion)
{
    // printf ("Comando CancelarComprobanteFiscal ejecutado en P272_100\n");

	// En este modelo el comando de Cancelación utilizado
	// para todos los documentos es el mismo
        ImpresorFiscalP272_100::CancelarComprobante ();
}
...
//
void
ImpresorFiscalP272_100::CancelarComprobante () throw(Excepcion)
{
    // printf ("Comando CancelarComprobante ejecutado en P272_100\n");
...
//
std::string
ImpresorFiscalP272_100::ObtenerNombreDeFantasia (unsigned Linea) throw (Excepcion)
{
    // printf ("Comando ObtenerNombreDeFantasia ejecutado en P272_100\n");
...
//
void
ImpresorFiscalP272_100::ConfigurarControladorPorBloque (
...
{
    // printf ("Comando ConfigurarControladorPorBloque ejecutado en P272_100\n");
...
//
void
ImpresorFiscalP272_100::ReporteZ (RTA_ReporteZX *R) throw (Excepcion)
{
    // printf ("Comando ReporteZ ejecutado en P272_100\n");
...
//
void
ImpresorFiscalP272_100::ReporteX (RTA_ReporteZX *R) throw (Excepcion)
{
    // printf ("Comando ReporteX ejecutado en P272_100\n");
...
//
void
ImpresorFiscalP272_100::AbrirDF (DocumentosFiscales Tipo) throw (Excepcion)
{
    // printf ("Comando AbrirDF ejecutado en P272_100\n");
...
//
void
ImpresorFiscalP272_100::Subtotal (bool Imprime, RTA_Subtotal *R) throw (Excepcion)
{
    // printf ("Comando Subtotal ejecutado en P272_100\n");
...
//
void
ImpresorFiscalP272_100::AbrirDNF (TiposDeEstacion EstacionDeImpresion) throw (Excepcion)
{
    // printf ("Comando AbrirDNF ejecutado en P272_100\n");
...
//
void
ImpresorFiscalP272_100::ImprimirVoucher (const std::string &NombreCliente,
...
{
    // printf ("Comando ImprimirVoucher ejecutado en P272_100\n");
