...
void
Debug::Debug(const char *Module, const char *Format, ...)
{
	char BufLog[512];
...
void
Debug::Debug(const std::string &Module, const Excepcion &e)
{
...
void
Debug::Debug(const std::string &Module, const std::string &Info)
{
	DebugIt(Module, Info);
}

void
Debug::Dump(const std::string &Module, const char *Information, unsigned Length)
{
