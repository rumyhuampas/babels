...
//
void
ImpresorFiscalP441_100::EstablecerModalidadResumenIVA (TiposDeResumenIVA Modo)
{
...
//
void
ImpresorFiscalP441_100::ObtenerDatosMemoriaDeTrabajo (RTA_ObtenerDatosMemoriaDeTrabajo *R) throw (Excepcion)
{
	// printf ("Comando ObtenerDatosMemoriaDeTrabajo ejecutado en P441_100\n");
...
//
unsigned
ImpresorFiscalP441_100::UltimoRemito () throw(Excepcion)
{
	// printf ("Comando UltimoRemito ejecutado en P441_100\n");
...
//
unsigned
ImpresorFiscalP441_100::PaginasDeUltimoDocumento () throw(Excepcion)
{
	// printf ("Comando PaginasDeUltimoDocumento ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::CAIUltimoDocumentoA (RTA_CAIUltimoDocumentoA * /* R */) throw (Excepcion)
{
	// printf ("Comando CAIUltimoDocumentoA ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::AbrirCajon () throw(Excepcion)
{
	// printf ("Comando AbrirCajon ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::AvanzarPapel(TiposDePapel Papel, unsigned Lineas) throw (Excepcion)
{
	unsigned Comando;

	// printf ("Comando AvanzarPapel ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::DatosCliente (
...
{
	// printf ("Comando DatosCliente ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::CargarLogo (const std::string & /* ArchivoBMP */) throw(Excepcion)
{
	// printf ("Comando CargarLogo ejecutado en P441_100\n");
...
void
ImpresorFiscalP441_100::CapacidadDocumentoSlip (bool &SoportaFA, bool &SoportaNC)
{
	// printf ("Comando CapacidadDocumentoSlip ejecutado en P441_100\n");
...
void
ImpresorFiscalP441_100::CapacidadDocumentoTicket (bool &SoportaFA, bool &SoportaNC)
{
	// printf ("Comando CapacidadDocumentoTicket ejecutado en P441_100\n");
...
void
ImpresorFiscalP441_100::CapacidadEstacion (bool &SoportaTicket, bool &SoportaSlip)
{
	// printf ("Comando CapacidadEstacion ejecutado en P441_100\n");
...
void
ImpresorFiscalP441_100::CapacidadCajon (bool &SoportaCajon)
{
	// printf ("Comando CapacidadCajon ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::BorrarFantasiaEncabezadoCola (bool BorrarFantasia, bool BorrarEncabezado, bool BorrarCola) throw (Excepcion)
{
	// printf ("Comando BorrarFantasiaEncabezadoCola ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::BorrarInformacionRemitoComprobanteOriginal () throw (Excepcion)
{
	// printf ("Comando BorrarInformacionRemitoComprobanteOriginal ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::ObtenerConfiguracion (RTA_ObtenerConfiguracion *R) throw (Excepcion)
{
	// printf ("Comando ObtenerConfiguracion ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::ReporteZ (RTA_ReporteZX *R) throw (Excepcion)
{
	// printf ("Comando ReporteZ ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::ReporteX (RTA_ReporteZX *R) throw (Excepcion)
{
	// printf ("Comando ReporteX ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::ReporteZIndividualPorFecha (FECHA FechaZ, RTA_ReporteZIndividual *R) throw (Excepcion)
{
	// printf ("Comando ReporteZIndividualPorFecha ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::ReporteZIndividualPorNumero (unsigned NumeroZ, RTA_ReporteZIndividual *R) throw (Excepcion)
{
	// printf ("Comando ReporteZIndividualPorNumero ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::AbrirDF (DocumentosFiscales Tipo) throw (Excepcion)
{
	// printf ("Comando AbrirDF ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::EspecificarIVANoInscripto (double /* Monto */) throw (Excepcion)
{
	// printf ("Comando EspecificarIVANoInscripto ejecutado en P441_100\n");
...
//
double
ImpresorFiscalP441_100::ImprimirPago (
						const std::string &Texto,
						double Monto,
						const std::string &DescripcionAdicional) throw (Excepcion)
{
	// printf ("Comando ImprimirPago ejecutado en P441_100\n");
...
//
double
ImpresorFiscalP441_100::DevolverPago (
						const std::string &Texto,
						double Monto,
						const std::string &DescripcionAdicional) throw (Excepcion)
{
	// printf ("Comando DevolverPago ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::AbrirDNF (TiposDeEstacion EstacionDeImpresion) throw (Excepcion)
{
	// printf ("Comando AbrirDNF ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::AbrirDNFH (DocumentosNoFiscalesHomologados Tipo, const std::string &Nro) throw (Excepcion)
{
	// printf ("Comando AbrirDNFH ejecutado en P441_100\n");

	// Verificamos si el Tipo de DNFH es válido para este modelo
	if ( !(	Tipo == TICKET_NOTA_CREDITO_A 		   || Tipo == TICKET_NOTA_CREDITO_B 		||
		    Tipo == TICKET_RECIBO_X       		   || Tipo == TICKET_PAGARE         		||
			Tipo == TICKET_PRESUPUESTO    		   || Tipo == TICKET_ENTREGA 	   			||
			Tipo == TICKET_ESTACIONAMIENTO    	   || Tipo == TICKET_COBRO_SERVICIO 		||
			Tipo == TICKET_INGRESO_DINERO   	   || Tipo == TICKET_RETIRO_DINERO 	   	 	||
			Tipo == TICKET_TALON_CAMBIO    		   || Tipo == TICKET_TALON_REPARTO 	   	 	||
			Tipo == TICKET_TALON_REGALO    		   || Tipo == TICKET_TALON_CUENTA_CORRIENTE ||
			Tipo == TICKET_AVISO_OPERACION_CREDITO || Tipo == TICKET_CUPON_PROMOCION 	 	||
...
//
void
ImpresorFiscalP441_100::ImprimirItemEnRemito (const std::string & /* Texto */,
									  double /* Cantidad */) throw (Excepcion)
{
	// printf ("Comando ImprimirItemEnRemito ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::ImprimirItemEnCuenta (const FECHA & /*FechaComprobante */,
							const std::string & /* NroComprobante */,
							const std::string & /* Texto */,
							double /* Debe */, double /* Haber */) throw (Excepcion)
{
	// printf ("Comando ImprimirItemEnCuenta ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::ImprimirItemEnCotizacion (const std::string & /* Detalle */) throw (Excepcion)
{
	// printf ("Comando ImprimirItemEnCuenta ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::ImprimirInfoEnDNFH (const unsigned IDCampo,
										  const std::string &Texto,
										  double Cantidad) throw (Excepcion)
{
	// printf ("Comando ImprimirInfoEnDNFH ejecutado en P441_100\n");
...
//
void
ImpresorFiscalP441_100::ImprimirFirmaEnCierreDNFH (bool ImprimeFirma) throw (Excepcion)
{
	// printf ("Comando ImprimirFirmaEnCierreDNFH ejecutado en P441_100\n");
