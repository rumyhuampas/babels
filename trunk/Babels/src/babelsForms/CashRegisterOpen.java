...
public class CashRegisterOpen extends javax.swing.JDialog implements IBabelsDialog {

    CashRegisterManager Manager;
    
    public CashRegisterOpen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Manager = new CashRegisterManager();
  ...
  @Override
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Monto inicial de Apertura de Caja");
