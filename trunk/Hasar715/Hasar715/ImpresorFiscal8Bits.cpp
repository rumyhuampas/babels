...
//
void
ImpresorFiscal8Bits::AbrirDF (DocumentosFiscales Tipo) throw (Excepcion)
{
	// printf ("Comando AbrirDF ejecutado en ImpresorFiscal8Bits\n");

	// Ejecutamos el método de la SuperClase 'ImpresorFiscal'
	ImpresorFiscal::AbrirDF (Tipo);

	// Reinicializamos 'NumberOfPages' en 0
	NumberOfPages = 0;
